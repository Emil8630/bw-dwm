...
static const int vertpadtab         		= 24;
...
/* ******************** Tags/Workspaces ******************** */
//static char *tags[] = {"WWW", "DEV", "SYS", "MUS"};
static char *tags[] = {"", "", "", ""};
...
/* Launch Apps */
static const char *stcmd[]  			= { "/usr/share/archcraft/dwm/bin/dwmterm.sh", NULL };
...
static const char *rofi_calc[]          = { "/usr/share/archcraft/dwm/rofi/bin/calc", NULL };
...
static Key keys[] = {
    ...
    { MODKEY|ShiftMask,         XK_c,                       spawn, {.v = rofi_calc } },
